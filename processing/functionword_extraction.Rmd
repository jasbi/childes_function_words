...
```{r babbles}
# add word_category column to english_tokens
...
english_tokens$syncategory[english_tokens$part_of_speech=="bab"] <- "babble"
english_tokens_contract$syncategory[english_tokens_contract$part_of_speech=="bab"] <- "babble"

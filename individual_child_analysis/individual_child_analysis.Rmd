...
# Cumulative_ppt Trajectories of Selected Children and Parents
```{r cumulative_ppt_trajectories, warning=FALSE, message=FALSE, fig.width=12, fig.height=8}
library(ggplot2)
library(dplyr)
...
# Cumulative_ppt Trajectors of Children Who Produced Most Tokens (Individual Plots)
```{r cumulative_ppt_trajectories, warning=FALSE, message=FALSE, fig.width=12, fig.height=8}
library(ggplot2)
library(dplyr)
...
# Cumulative_ppt Trajectories of Children Who Produced Most Tokens
```{r cumulative_ppt_trajectories, warning=FALSE, message=FALSE, fig.width=12, fig.height=8}
library(ggplot2)
library(dplyr)
...
ggplot(child_relfreq, aes(x = target_child_age, y = cumulative_ppt, color = target_child_name, group = target_child_name)) +
  ...
  theme_bw() +
  labs(
    title = "Cumulative Ppt for Selected Function Words",
    x = "Age (months)",
    y = "Cumulative Ppt",
    color = "Child"
  ) +
...
ggplot(
  ...
  labs(
    title = "Density of Token Ages for Each Top Ten Child (12-48 months)",
    x = "Age (months)",
    y = "Density",
    fill = "Child"
  ) +
...
ggplot(
  ...
  labs(
    title = "Density of Token Ages by Child (12-48 months)",
    x = "Age (months)",
    y = "Density"
  ) +
  theme_bw() +

...
author: "Masoud Jasbi", "Sunny Zhou"
date: "`r Sys.Date()`"
output: pdf_document
---
...
write_feather(all_english_tokens, "../raw_data/all_english_tokens.feather")
write_csv(speaker_stats, "../raw_data/speaker_stats.csv")
```

## Coding Speaker Roles

Here we group mothers and fathers together as "parents" and group children together as "child."

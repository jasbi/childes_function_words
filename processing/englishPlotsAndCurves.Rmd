...
a_plot <-
  ...
  geom_line(aes(y = predictions, color = "Fitted Values"), size = 1) + # Fitted values
  scale_color_manual(name = "Legend", values = c("Actual Data" = "black", "Fitted Values" = "blue")) +
  theme_bw() + labs(title="A", x="Age (Months)", y="") + 
...
nt_plot <-
  ...
  geom_line(aes(y = predictions, color = "Fitted Values"), size = 1) + # Fitted values
  scale_color_manual(name = "Legend", values = c("Actual Data" = "black", "Fitted Values" = "blue")) +
  theme_bw() + labs(title="n't", x="Child Age (Month)", y="Parts per Thousand") + 
  theme(legend.position = "none") +   
  theme(
    plot.title = element_text(size = 20, hjust = 0.5),
    axis.title.x = element_text(size = 16),
...
AND_plot <-
  ...
  geom_line(aes(y = predictions, color = "Fitted Values"), size = 1) + # Fitted values
  scale_color_manual(name = "Legend", values = c("Actual Data" = "black", "Fitted Values" = "blue")) +
  theme_bw() + labs(title="And", x="Child Age (Month)", y="Parts per Thousand") + 
  theme(legend.position = "none") +   
  theme(
    plot.title = element_text(size = 20, hjust = 0.5),
    axis.title.x = element_text(size = 16),
...
any_plot <-
  ...
  geom_line(aes(y = predictions, color = "Fitted Values"), size = 1) + # Fitted values
  scale_color_manual(name = "Legend", values = c("Actual Data" = "black", "Fitted Values" = "blue")) +
  theme_bw() + labs(title="Any", x="Age (Months)", y="Cumulative Relative Frequency (PPT)") + 
  theme(legend.position = "none") + scale_x_continuous(breaks = seq(0, 72, by = 3)) +   
  theme(
    plot.title = element_text(size = 20, hjust = 0.5),
    axis.title.x = element_text(size = 16),
...
just_plot <-
  ...
  geom_line(aes(y = predictions, color = "Fitted Values"), size = 1) + # Fitted values
  scale_color_manual(name = "Legend", values = c("Actual Data" = "black", "Fitted Values" = "blue")) +
  theme_bw() + labs(title="Just", x="Age (Months)", y="Cumulative Relative Frequency (PPT)") + 
  theme(legend.position = "none") + scale_x_continuous(breaks = seq(0, 72, by = 3)) +   
  theme(
    plot.title = element_text(size = 20, hjust = 0.5),
    axis.title.x = element_text(size = 16),
...
up_plot <-
  ...
  geom_line(aes(y = predictions, color = "Fitted Values"), size = 1) + # Fitted values
  scale_color_manual(name = "Legend", values = c("Actual Data" = "black", "Fitted Values" = "blue")) +
  theme_bw() + labs(title="Up", x="Age (Months)", y="Cumulative Relative Frequency (PPT)") + 
  theme(legend.position = "none") + scale_x_continuous(breaks = seq(0, 72, by = 3)) +   
  theme(
    plot.title = element_text(size = 20, hjust = 0.5),
    axis.title.x = element_text(size = 16),
...
```{r}
library(gridExtra)
grid.arrange(AND_plot, or_plot, not_plot, if_plot, sometimes_plot, more_plot, again_plot, in_plot, some_plot, with_plot, because_plot, why_plot, layout_matrix = rbind(c(1, 2, 3), c(4, 5, 6), c(7, 8, 9), c(10,11,12)))
```
